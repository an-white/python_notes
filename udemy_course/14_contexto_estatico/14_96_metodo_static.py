class Clase:
    ...
    def estatico():
        """
        el contexto estatico en python es todo lo que esta en la clase al ser cargada y
        el dinamico son los objetos que se pueden crear a partir de ella esto no permite acceder
        a las variables de instancia ni al self, solo se puede acceder a las variables de clase
        de manera indirecta de la siguiente manera
        """
...
ya que primero se carga la clase y luego se crean los objs en memoria
"""
