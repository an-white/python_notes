Nombres = []
while True:
    print('Introduzca los nombres de los elementos de la lista ' + str(
        len(Nombres) + 1) + ' O dejar vacio para terminar la lista')
    name = input()
    if name == '':
        break
...
for name in Nombres:
    print(
        ' ' + name)  # el espacio antes de name se coloca para dejar una separacion entre el margen de la ventana y el nombre de cada uno
