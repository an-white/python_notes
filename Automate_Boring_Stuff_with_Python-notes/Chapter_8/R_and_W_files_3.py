...
Emails=open('C:\\Users\\andre\\Desktop\\Emails.txt','w') # con el, 'w' si el .txt seleccinado no existe phyton lo creaara antes de escribir en el
...
Emails=open('C:\\Users\\andre\\Desktop\\Emails.txt','a') # el 'a' añadirá mas texto en la cadena para ir asi llenando el .txt
