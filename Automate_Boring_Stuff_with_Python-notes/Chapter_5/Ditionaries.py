...
# y su valor asignado se puede utilizar el metodo .get('key buscada', valor en caso de no estar contenido en el diccionario)

print('Que valor de key desea buscar')
k=input()
print('Existe un '+ k +' el cual tiene un valor asignado de ' + str(Dictionary.get('"'+str(k)+'"','No contenido')))
