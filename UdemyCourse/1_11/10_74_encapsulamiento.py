class Carro:
    def __init__(self, marca, puestos, año):
        # a este atributo no se deberia poder acceder para poder acceder a el se utiliza un decorador property para acceder indirectamente a el
        self._marca = marca
    ...
    # si no se define el decorador setter esto genera un atributo de solo lectura y dara un error si se intenta modificar
    @marca.setter
