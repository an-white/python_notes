# cada variable apunta a una dir de memoria unica que se le asigna una literal la cual almacena el valor de dicha variable 
# y se reasigna cada vez que se ejecuta el programa con la funcion id podemos ver dicha posicion de memoria
